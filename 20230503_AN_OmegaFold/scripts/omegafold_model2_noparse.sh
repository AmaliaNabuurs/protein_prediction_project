...
apptainer exec --nv -B /hpc:/hpc /hpc/local/Rocky8/pmc_vanheesch/singularity_images/omegafold-1.0.0.sif omegafold --weights_file=/hpc/pmc_vanheesch/projects/Amalia/protein_prediction_project/20230503_AN_OmegaFold/model2.pt --model 2 $1 $2
